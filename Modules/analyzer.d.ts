...
declare interface _NetworkBase extends BaseClass {
    ...
    getLinkCount(): number;
    getDeviceCount(): number;
    getDevice(s: string): _Device | undefined;
    getDeviceAt(n: number): _Device;
}
...
declare interface _LogicalWorkspaceBase extends BaseClass {
    ...
    */
    ...
    getComponentItem(s: string): _ComponentItem;
    getComponentItemsCount(): number;
    // x, y, z, text
    addNote(n: number, n2: number, n3: number, s: string): UUID;
...
declare interface _DeviceBase extends BaseClass {
    ...
    setPower(b: boolean): void;
    getCustomVarValueStrAt(n: number): string;
    removeCustomVar(s: string): boolean;
    getYPhysicalWS(): number;
    getModel(): string;
    setName(s: string): void;
    moveToLocInPhysicalWS(n: number, n2: number): boolean;
    hasCustomVar(s: string): boolean;
    getXCoordinate(): number;
    getYCoordinate(): number;
    getPortAt(n: number): _Port | null;
    serializeToXml(): string;
    getPower(): boolean;
    getCustomVarStr(s: string): string;
    getPortCount(): number;
    getXPhysicalWS(): number;
    removeModule(s: string): boolean;
    getCommandLine(): _TerminalLine;
    moveToLocation(n: number, n2: number): boolean;
    getType(): _DeviceType;
    getName(): string;
    getPort(s: string): _Port | null;
    ...
    addCustomVar(s: string, s2: string): void;
    getCustomVarNameAt(n: number): string;
}
...
declare interface _RouterPortBase extends _HostPort {
    ...
    setOspfDeadInterval(n: number): void;
    resetBandwidth(): void;
    setIpsOutID(s: string): void;
    setDelay(n: number): void;
    setOspfCost(n: number): void;
    ...
    setOspfHelloInterval(n: number): void;
    setRipSplitHorizon(b: boolean): void;
    getDelay(): number;
...
declare interface _ComponentItemBase extends BaseClass {
    ...
    getXCoordinate(): number;
    setY(n: number): void;
    moveTo(n: number, n2: number): void;
    device(): _Device;
    xVelocity(): number;
    getYCoordinate(): number;
    setYVelocity(n: number): void;
    setX(n: number): void;
    setXVelocity(n: number): void;
    moveBy(n: number, n2: number): void;
